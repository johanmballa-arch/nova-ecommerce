    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
        ...
        <p style="color: #444; font-size: 15px; line-height: 1.6;">
          Merci de t'être inscrit. Utilise le code ci-dessous pour vérifier ton adresse e-mail :
        </p>
        ...
        <p style="color: #888; font-size: 13px;">
          Ce code expire dans 15 minutes. Si tu n'es pas à l'origine de cette inscription, ignore cet e-mail.
        </p>
      </div>
    `,
  });
